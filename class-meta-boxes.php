...
if ( ! class_exists( 'Indie88_Add_Meta_Box' ) ) :

  class Indie88_Add_Meta_Box {
    ...
    public function render_meta_box( $post, $args ) {
      ...
      foreach( $fields as $field ) {
        ...
        $label = ! empty( $field->label ) ? sprintf( '<label for="%s" style="width: 130px; display: inline-block;">%s </label>', $field->id, $field->label ) : '';
