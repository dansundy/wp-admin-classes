...
if ( ! class_exists( 'Indie88_Customize' ) ) :
  class Indie88_Customize {
    ...
    public function set_controls( $wp_customize, $id, $args, $type ) {
      switch($type) {
        ...
        case "image":
          ...
          break;
        case "textarea":
          $wp_customize->add_control( new NC_Customize_Textarea_Control( $wp_customize, $id, $args ) );
          break;
        case "customtext":
          $wp_customize->add_control( new NC_Customize_Text_Control( $wp_customize, $id, $args ) );
          break;
        case "customdesc":
          $wp_customize->add_control( new NC_Customize_Description( $wp_customize, $id, $args ) );
          break;
        // case "select":
        //   $wp_customize->add_control( new NC_Customize_Select_Control( $wp_customize, $id, $args ) );
        //   break;
        default:
  ...
  if ( class_exists( 'WP_Customize_Control' ) ) :
    ...
    class NC_Customize_Textarea_Control extends WP_Customize_Control {
    ...
    class NC_Customize_Text_Control extends WP_Customize_Control {
    ...
    class NC_Customize_Select_Control extends WP_Customize_Control {
      public $type = 'select';
      public $description = '';
    ...
    class NC_Customize_Description extends WP_Customize_Control {
